...
class ProbabilisticEnsemble(ParallelizedEnsemble):
    ...
    def __init__(
        ...
        print_banner(f"Initialize ProbabilisticEnsemble with ensemble_size={ensemble_size}, hidden_sizes={hidden_sizes}, spectral_norm={spectral_norm}, separate_mean_var={self.separate_mean_var}")
